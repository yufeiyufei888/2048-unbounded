...
// ============ 主循环 ============
const DEPTH = 5, LIMIT = 6, BUDGET = 40000;
const MAX_GAMES = 500, TIME_LIMIT_MS = 1000 * 60 * 40;
const START = Date.now();
let best = { score: -1 }, games = 0, totalSteps = 0;
const hist = [];

console.log('引擎 v3 启动：蛇形权重 + 危险惩罚 + 自适应深度');
